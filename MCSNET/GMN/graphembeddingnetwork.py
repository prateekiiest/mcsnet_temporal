...
def graph_prop_once(node_states,
    ...
    #tensor = scatter(messages, to_idx,dim_size=node_states.shape[0],dim=0,reduce="sum")
    return tensor
...
class GraphAggregator(nn.Module):
    ...
    def forward(self, node_states, graph_idx, n_graphs):
        ...
        #graph_states = scatter(node_states_g, graph_idx, dim_size=n_graphs, dim=0,reduce="sum")
...
class GraphAggregator3(nn.Module):
    """This module computes graph representations by aggregating from parts."""
    ...
    def __init__(self,
        ...
        Args:
          ...
          name: name of this module.
        """
        super(GraphAggregator3, self).__init__()
...
class GraphAggregator2(nn.Module):
    """This module computes graph representations by aggregating from parts."""
    ...
    def __init__(self,
        ...
        Args:
          ...
          name: name of this module.
        """
        super(GraphAggregator2, self).__init__()
...
class GraphAggregator1(nn.Module):
    """This module computes graph representations by aggregating from parts."""
    ...
    def __init__(self,
        ...
        Args:
          ...
          name: name of this module.
        """
        super(GraphAggregator1, self).__init__()
    ...
    def forward(self, node_states, graph_idx, n_graphs):
        ...
        #graph_states = unsorted_segment_sum(node_states_g, graph_idx, n_graphs)
        graph_states = unsorted_segment_sum(node_states, graph_idx, n_graphs)
