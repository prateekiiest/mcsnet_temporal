...
if __name__ == "__main__":
  ...
  ap.add_argument("--MIN_QUERY_SUBGRAPH_SIZE",        type=int,   default=9)
  ...
  #We'd like 50 qgrs of size 10, thank you!
  ...
  logger.info("Loading corpus subgraphs")
  ...
  with ProcessPool(max_workers=100) as pool:
    while n_queries <no_of_query_subgraphs:
      ...
      if r>=0.1 and r<=0.4:
          ...
          logger.info("Discarded due to ratio : %s",r)
  ...
  fp = av.DIR_PATH + "/Datasets/preprocessed/" + av.DATASET_NAME + "40k_query_" + \
